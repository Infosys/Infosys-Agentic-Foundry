...
async def executor_critic_builder(agent_name, agent_goal, workflow_description, tool_prompt, llm):
    ...
    return {"MULTI_AGENT_SYSTEM_PROMPTS_RE": agent_config_resp["MULTI_AGENT_SYSTEM_PROMPTS"]}
