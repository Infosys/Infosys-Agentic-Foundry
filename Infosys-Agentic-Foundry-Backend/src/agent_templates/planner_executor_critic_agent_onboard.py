...
class MultiAgentOnboard(BaseAgentOnboard):
    """
    MultiAgentOnboard is a specialized onboarding service for multi-agent systems, extending the BaseAgentOnboard class.
    It builds system prompts for various agents in the multi-agent system.
    """

    def __init__(self, agent_service_utils: AgentServiceUtils):
        super().__init__(agent_type=AgentType.PLANNER_EXECUTOR_CRITIC_AGENT, agent_service_utils=agent_service_utils)
