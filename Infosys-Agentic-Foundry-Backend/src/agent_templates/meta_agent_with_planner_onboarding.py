...
async def onboard_meta_agent_with_planner(
                    agent_name: str,
                    agent_goal: str,
                    workflow_description: str,
                    worker_agents_prompt: str, llm: Union[AzureChatOpenAI, ChatOpenAI, ChatGoogleGenerativeAI]
                ) -> Dict[str, str]:
    """
    ...
    Args:
        ...
        tool_prompt: A formatted string detailing the available worker agents.
