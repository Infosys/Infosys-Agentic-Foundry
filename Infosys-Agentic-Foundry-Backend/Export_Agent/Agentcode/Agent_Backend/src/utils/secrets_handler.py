...
class PublicKeysManager:
    ...
    def store_public_key(self, key_name: str, key_value: str, description: str = None, created_by: str = None) -> bool:
        """
        Store an encrypted public key
...
def store_public_key(key_name: str, key_value: str, description: str = None) -> bool:
    ...
    return public_keys_manager.store_public_key(key_name, key_value, description, current_user)
