...
async def lifespan(app: FastAPI):
    ...
    """
    global mcp_tool_repo,mcp_tool_service,planner_executor_agent_inference,embedding_model,cross_encoder,db_manager, tool_repo, agent_repo,chat_history_repo, tool_service, agent_service,multi_db_connection_manager, \
           chat_service, inference_utils, react_agent_inference,feedback_learning_repo, \
