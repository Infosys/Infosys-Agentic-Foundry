...
async def lifespan(app: FastAPI):
    ...
    """
    global mcp_tool_service,mcp_tool_repo,embedding_model,cross_encoder,db_manager, tool_repo, agent_repo,chat_history_repo, tool_service, agent_service,multi_db_connection_manager, \
