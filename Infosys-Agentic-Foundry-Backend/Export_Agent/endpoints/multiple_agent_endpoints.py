...
from exportagent.src.inference.planner_executor_critic_agent_inference import MultiAgentInference
from exportagent.src.schemas import AgentInferenceRequest,ChatSessionRequest,TempAgentInferenceRequest,TempAgentInferenceHITLRequest
...
async def lifespan(app: FastAPI):
    ...
    global mcp_tool_repo,mcp_tool_service,embedding_model,cross_encoder,db_manager, tool_repo, agent_repo,chat_history_repo, tool_service, agent_service,multi_db_connection_manager, \
           chat_service, inference_utils, react_agent_inference, react_critic_agent_inference,planner_executor_agent_inference,planner_meta_agent_inference,multi_agent_inference,meta_agent_inference,feedback_learning_repo, \
    ...
    try:
        ...
        react_agent_inference = ReactAgentInference(inference_utils=inference_utils)
        multi_agent_inference = MultiAgentInference(inference_utils=inference_utils)
        planner_executor_agent_inference = PlannerExecutorAgentInference(inference_utils=inference_utils)
        react_critic_agent_inference = ReactCriticAgentInference(inference_utils=inference_utils)
        meta_agent_inference = MetaAgentInference(inference_utils=inference_utils)
        planner_meta_agent_inference = PlannerMetaAgentInference(inference_utils=inference_utils)

        agent_handlers_for_this_export = {
        "react_agent": react_agent_inference,
        "multi_agent":multi_agent_inference,
        "react_critic_agent":react_critic_agent_inference,
        "meta_agent":meta_agent_inference,
        "planner_meta_agent":planner_meta_agent_inference,
        "planner_executor_agent":planner_executor_agent_inference
        }
