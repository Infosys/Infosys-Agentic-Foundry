...
import { deleteTool, getTools } from "../../services/toolService";
...
import { checkToolEditable } from "../../util.js";
...
function ToolsCard(props) {
  ...
  const handelDeleteTools = async (toolId) => {
    ...
    if (response?.is_delete) {
      ...
      const errorMsg = response?.status_message
        ...
        {!isDeleteClicked && (
          <>
            ...
            <div className={style["btn-grp"]}>
              ...
              <button onClick={handleEditClick} className={style["edit-btn"]}>
